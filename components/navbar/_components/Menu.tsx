            ...
            <div className="flex">
              <ul className="grid  p-2 md:w-[400px]  lg:w-[250px] hover:cursor-pointer border-r">
                <div className="flex items-center gap-1 hover:bg-gray-400/10 p-1 rounded-sm">
                  <span className=" mr-2"><PiBookOpenTextLight size={24} color="red"/></span>
                  <div className="">
                    <a>Wikis</a>
                ...
                <div className="flex items-center gap-1 hover:bg-gray-400/10 p-1 rounded-sm">
                  <span className=" mr-2"><PiTargetLight size={24} color="blue"/></span>
                  <div className="">
                    <a>Projects</a>
                    <p className="text-gray-400 text-sm font-light">
                ...
                <div className="flex items-center gap-1 hover:bg-gray-400/10 p-1 rounded-sm">
                  <span className=" mr-2"><PiFileThin size={24} color="yellow" /></span>
                  <div className="">
                    <a>Docs</a>
                    <p className="text-gray-400 text-sm font-light">
                      Simple & Powerful
                ...
                <div className="flex items-center gap-1 hover:bg-gray-400/10 p-1 rounded-sm">
                  <span className=" mr-2"><PiSparkleLight size={24} color="red" /></span>
                  <div className="">
                    <a>Bird Assistant</a>
                    <p className="text-gray-400 text-sm font-light">
